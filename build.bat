...
cd bin
jar -cvfe ..\jar\org.igrok-net.configurator_v005.jar org.igrok_net.configurator.Configurator *
cd ..

xcopy /y /q jar\org.igrok-net.configurator_v005.jar lib-gui\org.igrok-net.configurator_v005.jar
...
cd gui_bin
jar -cvfe ..\jar\org.igrok-net.configurator-gui_v005.jar org.igrok_net.configurator_gui.ConfiguratorGui *
cd ..
